...
class DessertDataSource extends DataTableSource {
  ...
  void _onSelectedRow(bool selected, Dessert _dessert) async {
    if (selected) {
      _selectedDesserts.add(_dessert);
    } else {
      _selectedDesserts.remove(_dessert);
    }
    notifyListeners();
  }
  ...
  void _deleteSelected() async {
    if (_selectedDesserts.isNotEmpty) {
      ...
      for (Dessert _dessert in temp) {
        _desserts.remove(_dessert);
        _selectedDesserts.remove(_dessert);
      }
    }
    notifyListeners();
  ...
  List<Dessert> get selectedDesserts => _selectedDesserts;
...
//                  },
  ...
  void _handleDataSourceChanged() {
    setState(() {
      _selectedDesserts = _dessertsDataSource._selectedDesserts;
    });
  }
