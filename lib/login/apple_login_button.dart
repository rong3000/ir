...
class AppleLoginButton extends StatelessWidget {
  ...
  AppleLoginButton({Key key, @required bool disableButton})
  ...
  Widget build(BuildContext context) {
    return RaisedButton.icon(
      ...
      label: Text(allTranslations.text('app.login-screen.apple-signin-label'), style: TextStyle(color: Colors.white)),
